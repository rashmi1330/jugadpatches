...
namespace Drupal\products\Response;
 ...
 *
 * @package Drupal\products\Response
 */
class ProductQrImageResponse extends Response {
  ...
  private function generateQrCode(string $string = '') {
    $logoPath = drupal_get_path('module', 'products') . '/images/symfony.png';
